#!/usr/bin/env python3
"""
Script to update the HTML template in enhanced_link_checker.py
with Sonatype Design System colors, properly formatted for Python f-string
"""

# The new CSS with proper escaping for Python f-strings (double braces)
...
# Find line 793 and line 1011
# Keep lines 1-793, replace 794-1011 with new template, then continue with 1012+
before_template = lines[:793]
after_template = lines[1011:]

# Write the updated file
with open('enhanced_link_checker.py', 'w') as f:
    # Write lines before template
    f.writelines(before_template)
    ...
    # Write lines after template
    f.writelines(after_template)

print("✅ Successfully updated HTML template with Sonatype Design System!")
print("🎨 New features:")
print("   - Blue gradient header with tomato accent border")
print("   - Radix UI color palette (Blue, Tomato, Gray)")
print("   - Inter font family")
print("   - Modern stat cards with hover effects")
print("   - Gradient backgrounds for badges")
print("   - Responsive design")
print("   - Premium Sonatype brand look")
