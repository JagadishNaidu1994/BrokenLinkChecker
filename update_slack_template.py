#!/usr/bin/env python3
"""
Update Slack notification template to match the simplified format
"""
...
# Start from the method definition to the end of the method
...
'''
    ...
    print("✅ Successfully updated Slack notification template!")
    print("\n📝 New template features:")
    print("   - Simplified format matching your example")
    print("   - Single-line stats: 'X links checked | Y broken found'")
    print("   - Cleaner category names (without 'Sonatype' prefix)")
    print("   - Smarter key issues detection (by domain/pattern)")
    print("   - Removed header block for cleaner look")
    print("   - Removed heart emoji from closing")
